...
models = [
    ...
    'models/conv-dog-basicFC-c_size15-layersep-reg_h0.01-hidden9-exp_nameconv-dog.pkl'
]
        ...
        for model in models:
            for noise_len in [256]:
                os.system(
                    ...
                    ./scripts/run_gan_cpu.sh --neuron={neuron} --save_path="output/gan_output" --noise_len={noise_len} --perc={perc} --name="{name}" --model="{model}" --epochs=50')